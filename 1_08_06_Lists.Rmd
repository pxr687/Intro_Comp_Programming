...
```{note}
This page is adapted from [Brett and co-authors (2023)](https://odsti.github.io/cfd-textbook/lists.html). See the [license](https://github.com/pxr687/Intro_Comp_Programming/blob/main/license.md) page for more information.
```
