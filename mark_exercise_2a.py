...
def check_answer_1(answer_1, 
    ...
    conditions = np.array([soft_assert(answer_1 in ["a", "b", "c"],
                              f"Your answer to {question_name} is **NOT CORRECT!** `{answer_name}`  should be `'a'`, `'b'`or `'c'`. Make sure you did not forget to use quotation marks! `'`",
                                return_mark=return_mark),
                            soft_assert(answer_1 == obs_2,
                              f"Your answer to {question_name} is **NOT CORRECT!** `{answer_name}` is the wrong answer.",
                                return_mark=return_mark)])
...
def check_answer_3(answer_3, 
    ...
    conditions = np.array([soft_assert(answer_3 in ["a", "b", "c", "d"],
                              f"Your answer to {question_name} is **NOT CORRECT!** `{answer_name}`  should be `'a'`, `'b'`, `'c'` or `'d'`. Make sure you did not forget to use quotation marks! `'`",
                                return_mark=return_mark),
